...
const genieacsApi = {
    ...
    async setParameterValues(deviceId, parameters) {
        try {
            ...
            // Kirim refresh task untuk kedua band WiFi
            const refreshTasks = [
                {
                    name: "refreshObject",
                ...
                {
                    name: "refreshObject",
                    objectName: "InternetGatewayDevice.LANDevice.1.WLANConfiguration.5"
                }
            ];
            ...
            for (const refreshTask of refreshTasks) {
                ...
                console.log(`Refresh task response for ${refreshTask.objectName}:`, refreshResponse.data);
            }
    ...
    async getDeviceInfo(deviceId) {
        try {
            ...
            // Get all devices and find the specific one (more reliable approach)
