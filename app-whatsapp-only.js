...
global.appSettings = {
  ...
  // Mikrotik (gunakan loader baru, hapus dari global.appSettings)
...
// Hapus inisialisasi GenieACS dan Mikrotik dari global.appSettings
// Gunakan loader dinamis untuk GenieACS dan Mikrotik
const { getMikrotikConfig } = require('./config/mikrotikConfig');
const { getGenieACSConfig } = require('./config/genieacsConfig');

console.log('Global settings initialized:');
const mikrotikConfig = getMikrotikConfig();
const genieacsConfig = getGenieACSConfig();
console.log('- Mikrotik:', mikrotikConfig.host + ':' + mikrotikConfig.port);
console.log('- GenieACS:', genieacsConfig.url);
console.log('- Web Port:', process.env.PORT || '3501');
